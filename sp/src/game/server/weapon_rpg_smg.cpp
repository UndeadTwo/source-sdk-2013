...
class CWeaponRPGSMG : public CHLSelectFireMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponRPGSMG, CHLSelectFireMachineGun);
...
IMPLEMENT_SERVERCLASS_ST(CWeaponRPGSMG, DT_WeaponRPGSMG)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_rpg_smg, CWeaponRPGSMG);
PRECACHE_WEAPON_REGISTER(weapon_rpg_smg);

BEGIN_DATADESC(CWeaponRPGSMG)
...
acttable_t	CWeaponRPGSMG::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponRPGSMG);

#ifdef MAPBASE
// Allows Weapon_BackupActivity() to access the SMG1's activity table.
acttable_t *GetRPGSMGActtable()
{
	return CWeaponRPGSMG::m_acttable;
}

int GetRPGSMGActtableCount()
{
	return ARRAYSIZE(CWeaponRPGSMG::m_acttable);
}
#endif

//=========================================================
CWeaponRPGSMG::CWeaponRPGSMG()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::Precache(void)
{
...
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::Equip(CBaseCombatCharacter *pOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
	...
	{
		//NPC handling of SMG1 altfire, holy shit does source need some refactoring work.
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponRPGSMG::GetPrimaryAttackActivity(void)
{
	if (m_nShotsFired < 2)
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CWeaponRPGSMG::Reload(void)
{
	bool fRet;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::AddViewKick(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::PrimaryAttack(void)
{
	...
	CMissile* m_hMissile = CMissile::Create(muzzlePoint, vecAngles, GetOwner()->edict());
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPGSMG::SecondaryAttack(void)
{
}
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponRPGSMG::WeaponRangeAttack2Condition(float flDot, float flDist)
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponRPGSMG::GetProficiencyValues()
{
